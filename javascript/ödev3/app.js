...
const categories = menu.reduce(
  (values, items) => {
    if (!values.includes(items.category)) values.push(items.category);
    return values;
  },
  ["All"]
);
...
const categoryList = () => {
  ...
  btn_container.innerHTML = categoryBtn;

  const categoryFilter = document.querySelectorAll(".btn-item");
